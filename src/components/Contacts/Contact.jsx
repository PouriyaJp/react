                        ...
                        <div className="col-md-7 col-sm-7">
                            <ul className="list-group">
                                <li className="list-group-item list-group-item-dark">
                                    نام و نام خانوادگی
                                    {" : "}
                                    <span className="fw-bold">پوریا جمشیدپور</span>
                                </li>
                                <li className="list-group-item list-group-item-dark">
                                    شماره همراه
                                    {" : "}
                                    <span className="fw-bold">09380123465</span>
                                </li>
                                <li className="list-group-item list-group-item-dark">
                                    آدرس ایمیل
                                    {" : "}
                                    <span className="fw-bold">pouriya2910@gamil.com</span>
                                </li>
                            </ul>
                        </div>
